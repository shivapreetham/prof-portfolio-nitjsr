...
import { AnalyticsEvent, EVENT_TYPES } from '@/models/models';
...
export async function POST(request) {
  try {
    ...
    const analyticsEvents = events.map(data => ({
    ...
    return NextResponse.json({ success: true, count: analyticsEvents.length }, { status: 201 });
  } catch (error) {
