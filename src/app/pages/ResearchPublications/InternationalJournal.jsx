...
const InternationalJournal = ({ propData: publications, backendData = [] }) => {
            ...
            {article.authorsList.length > 0 && (
              <div className="mt-2 flex flex-wrap gap-2">
                ...
                {article.authorsList.map((author, idx) => (
                  <span key={`${article.title}-author-${idx}`} className="bg-gray-200 px-2 py-1 rounded text-xs text-black">
                    {author}
                  </span>
                ))}
              </div>
