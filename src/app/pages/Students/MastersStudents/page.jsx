    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <main className="container mx-auto px-6 py-10 max-w-6xl">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold text-black mb-2">Masters Students</h1>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            <div className="p-6">
              <h3 className="text-xl font-semibold mb-6 text-[#064A6E]">Masters Theses Supervised</h3>
