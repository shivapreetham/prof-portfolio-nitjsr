    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <main className="container mx-auto px-6 py-10 max-w-6xl">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-4xl font-bold text-[#064A6E] mb-2">Masters Students</h1>
          <div className="h-[3px] w-24 bg-[#0284C7] rounded-full mb-4"></div>
          <p className="text-gray-600">MTech thesis supervision and guidance</p>
        </motion.div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            {data.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-gray-600 mb-2">No Masters Students Found</h3>
                <p className="text-gray-500">Masters student information will appear here once available.</p>
              </div>
            )}
          </div>
        )}
