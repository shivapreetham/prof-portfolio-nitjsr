          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            {data.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-gray-600 mb-2">No Bachelor Students Found</h3>
                <p className="text-gray-500">Bachelor student information will appear here once available.</p>
              </div>
            )}
          </div>
        )}
