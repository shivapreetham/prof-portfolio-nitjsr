  ...
  return (
    <div data-theme="light" className="min-h-screen bg-base-200">
      ...
      <div className="container mx-auto px-4 py-16 text-center">
        <h2 className="text-3xl font-bold mb-4">Welcome to My Academic Portfolio</h2>
        <p className="text-lg opacity-80">
          Explore my research, publications, and contributions in the field.  
          Use the navigation above to learn more.
          lorem500
        </p>
      </div>
    </div>
